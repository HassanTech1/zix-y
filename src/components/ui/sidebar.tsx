...
>(({ className, style, children, defaultOpen = false, ...props }, ref) => {
...
>(({ side = "left", variant = "sidebar", collapsible = "icon", className, children, ...props }, ref) => {
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "transition-all duration-300 ease-in-out fixed inset-y-0 z-10 hidden h-auto flex-col md:flex",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="title"
      className={cn("p-4 text-lg font-semibold", "group-data-[state=collapsed]:hidden", className)}
      {...props}
    />
  )
})
...
const SidebarContentWrapper = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
SidebarContentWrapper.displayName = "SidebarContent"
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity] ease-linear focus-visible:ring-2",
        "group-data-[state=collapsed]:px-0 group-data-[state=collapsed]:opacity-0 group-data-[state=collapsed]:h-0 group-data-[state=collapsed]:invisible",
        className
      )}
      {...props}
    />
...
>(({ className, isSubmenu, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    className={cn("flex w-full min-w-0 flex-col gap-1",
      isSubmenu && 'pl-5 border-l border-sidebar-border ml-3',
     className)}
    {...props}
  />
))
